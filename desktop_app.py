...
class GameAnalysisApp(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Me Ensina A.I - Análise de Gameplay")
    ...
    def show_auth_screen(self):
        ...
        tabview = ctk.CTkTabview(self, width=400)
        ...
        login_button = ctk.CTkButton(login_frame, text="Entrar", command=lambda: self.login(email_entry.get(), password_entry.get()))
        ...
        signup_button = ctk.CTkButton(signup_frame, text="Cadastrar", command=lambda: self.signup(new_email_entry.get(), new_password_entry.get(), confirm_password_entry.get()))
    ...
    def show_game_selection(self):
        ...
        label = ctk.CTkLabel(self, text=f"Bem-vindo, {self.user_email}!\nEscolha um jogo para analisar:", font=ctk.CTkFont(size=20, weight="bold"))
        label.pack(pady=20)
        
        cs_button = ctk.CTkButton(self, text="Counter-Strike 2", command=lambda: self.select_game("Counter-Strike 2"), height=50)
        cs_button.pack(pady=10, padx=20, fill="x")
        
        sf_button = ctk.CTkButton(self, text="Street Fighter 5", command=lambda: self.select_game("Street Fighter 5"), height=50)
        sf_button.pack(pady=10, padx=20, fill="x")

        history_button = ctk.CTkButton(self, text="Ver Histórico de Análises", command=self.show_history, height=40)
    ...
    def show_history(self):
        ...
        back_button = ctk.CTkButton(self, text="Voltar", command=self.show_game_selection)
        back_button.pack(pady=10, anchor="w", padx=10)

        csv_content = get_reports_csv()
        text_area = Text(self, wrap='word', bg="#2b2b2b", fg="white", insertbackground="white")
    ...
    def show_analysis_screen(self):
        ...
        """
        instruction_label = ctk.CTkLabel(self, text=instructions, justify="left")
        instruction_label.pack(pady=10)

        self.record_button = ctk.CTkButton(self, text="Começar Gravação", command=self.toggle_recording, height=40)
        self.record_button.pack(pady=20)
        
        self.status_label = ctk.CTkLabel(self, text="", font=ctk.CTkFont(size=14))
        self.status_label.pack(pady=10)

        back_button = ctk.CTkButton(self, text="Escolher outro jogo", command=self.show_game_selection)
    ...
    def show_results_screen(self, report):
        ...
        report_text = Text(self, wrap='word', height=25, width=80, bg="#2b2b2b", fg="white", insertbackground="white")
        ...
        new_analysis_button = ctk.CTkButton(button_frame, text="Nova Análise (Mesmo Jogo)", command=self.show_analysis_screen)
        new_analysis_button.pack(side="left", padx=10)

        change_game_button = ctk.CTkButton(button_frame, text="Escolher Outro Jogo", command=self.show_game_selection)
